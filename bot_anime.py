...
def autenticar_blogger():
    ...
    # Canjea el refresh token por un access token válido
...
def main():
    ...
    if not BLOGGER_REFRESH_TOKEN:
        ...
        return
    if not BLOGGER_CLIENT_ID:
        print("❌ Error: BLOGGER_CLIENT_ID no está configurado")
        return
    if not BLOGGER_CLIENT_SECRET:
        print("❌ Error: BLOGGER_CLIENT_SECRET no está configurado")
        return
